...
public class feliciter extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feliciter);
        ...
        evt = (TextView) findViewById(R.id.fel);
        evt.setText(getIntent().getStringExtra("Evenement"));
        cat1 = (Button)findViewById(R.id.cattt1);
        cat1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent intent = new Intent(
                        feliciter.this,MapsActivity.class
        ...
        cat2 = (Button)findViewById(R.id.cattt2);
        ...
        cat3 = (Button)findViewById(R.id.cattt3);
        ...
        cat4 = (Button)findViewById(R.id.cattt4);
        ...
        cat5 = (Button)findViewById(R.id.cattt5);
        ...
        cat6 = (Button)findViewById(R.id.cattt6);
        ...
        cat7 = (Button)findViewById(R.id.cattt7);
        ...
        cat8 = (Button)findViewById(R.id.cattt8);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.dec){
            ...
            Intent intent = new Intent(
                    feliciter.this,MainActivity.class
        ...
        if(id == R.id.Cons){
            ...
            Intent intent = new Intent(
                    feliciter.this,consultMaps.class
        ...
        if(id == R.id.historique){
            ...
            Intent intent = new Intent(
                    feliciter.this,cunsultHistorique.class
        ...
        if(id == R.id.profile){
            ...
            Intent intent = new Intent(
                    feliciter.this,monProfil.class
