...
public class consult2Maps extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consult2_maps);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(),consult2Events.class);
    ...
    private void geoLocate() {
        ...
        Geocoder geocoder = new Geocoder(consult2Maps.this);
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
            ...
            loc.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Geocoder geocoder = new Geocoder(consult2Maps.this, Locale.getDefault());
                    ...
                    final MarkerOptions options = new MarkerOptions().position(new LatLng(lati,longi));
